...
function AdminDashboardContent() {
  ...
  const {
    ...
    refetch,
  } = useAdminUsers(page, 20, search, isAuthorized)
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      {stats?.freeSubscriptions || 0} free •{" "}
                      {stats?.paidSubscriptions || 0} paid
                    </p>
                  </div>
                            ...
                            >
                              ...
                              <td className="whitespace-nowrap px-4 py-4">
                                ...
                                {subscription.plan.stripePriceId && (
                                  <div className="text-xs text-gray-500">
                                    {subscription.plan.stripePriceId.substring(
                                      0,
                                      20
                                    )}
                                    ...
                              ...
                              <td className="px-4 py-4 text-sm text-gray-500">
                                <div className="space-y-1">
                                  ...
                                  <div className="text-xs text-gray-400">
                                    Models:{" "}
                                    {subscription.limits.allowedModels.length}
                                  </div>
                                </div>
                              </td>
                              <td className="whitespace-nowrap px-4 py-4 text-sm text-gray-500">
                    ...
                    {users.map((user) => (
                      <tr key={user.id} className="hover:bg-gray-50">
                        ...
                        <td className="whitespace-nowrap px-6 py-4">
                          ...
                          {user.subscription && (
                            <div className="text-xs text-gray-500">
                              {user.usage.topicsCount}/
                              {user.subscription.maxTopics} topics •{" "}
                              {user.usage.quizzesCount}/
                              {user.subscription.maxQuizzes} quizzes
                            </div>
                          )}
                        </td>
                        <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-500">
                          {user.usage.topicsCount} topics •{" "}
                          {user.usage.quizzesCount} quizzes
                        </td>
                        <td className="whitespace-nowrap px-6 py-4">
                          <span
                            className={`inline-flex rounded-full px-2 py-1 text-xs font-medium ${
